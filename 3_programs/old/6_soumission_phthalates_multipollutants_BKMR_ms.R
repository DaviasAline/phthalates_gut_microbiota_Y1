...
plot_risks.overall_phthalates_alpha_run3 <- 
  plot_risks.overall_sperich(results_bkmr_overall_phthalates_alpha, est = est_rich_t2, sd = sd_rich_t2, title = "2nd trim. exposure") +
  ...
  plot_risks.overall_sperich(results_bkmr_overall_phthalates_alpha, est = est_rich_t3, sd = sd_rich_t3, title = "3rd trim. exposure") + 
...
ggsave("4_output/phthalates/bkmr_phthalates/Run3 (ms)/plot_risks.overall_phthalates_alpha_run3ms.tiff", 
       plot_risks.overall_phthalates_alpha_run3, 
       device = "tiff",
       units = "mm",
       dpi = 300, 
...
ggsave("4_output/phthalates/bkmr_phthalates/Run3 (ms)/plot_risks.singvar_phthalates_run3ms.tiff", 
       plot_risks.singvar_phthalates, 
       device = "tiff",
       units = "mm",
       dpi = 300, 
...
# reload -----
resuts_bkmr_phthalates_alpha_run1 <- list
results_bkmr_phthalates_rich_t2 <- list[[1]][[1]]
results_bkmr_phthalates_sha_t2 <- list[[1]][[2]]
results_bkmr_phthalates_fai_t2 <- list[[1]][[3]]

results_bkmr_phthalates_rich_t3 <- list[[2]][[1]]
results_bkmr_phthalates_sha_t3 <- list[[2]][[2]]
results_bkmr_phthalates_fai_t3 <- list[[2]][[3]]

results_bkmr_phthalates_rich_M2 <- list[[3]][[1]]
results_bkmr_phthalates_sha_M2 <- list[[3]][[2]]
results_bkmr_phthalates_fai_M2 <- list[[3]][[3]]

results_bkmr_phthalates_rich_Y1 <- list[[4]][[1]]
results_bkmr_phthalates_sha_Y1 <- list[[4]][[2]]
results_bkmr_phthalates_fai_Y1 <- list[[4]][[3]]
...
TracePlot(fit = results_bkmr_phthalates_sha_Y1, par = "beta", sel = TRUE)
